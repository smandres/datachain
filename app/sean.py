...
st.markdown("<h1 style='text-align: center; font-weight:bold; font-family:candara; padding-top: 0rem;'> dataChain</h1>", unsafe_allow_html=True)
            ...
            if response['role'] == 'assistant':
                ...
                with st.chat_message("ai"):
                    ...
                    if 'image_file_file_id' in response:
                        ...
                        # TODO:
                        #if image_name in clicked_buttons:
                        #    st.markdown(clicked_buttons[image_name])
                        # END
                    ...
                    # else:
                        ...
                        #     image = Image.open(image_path)
                        #     st.image(image)
                        #     if st.button("Explain with Vision", key=image_name):
                        #         try:
                        #             vision_response = chain.vision(image_name)
                        #             explanation = vision_response['choices'][0]['message']['content']
...
#st.code(printed_steps)
#st.markdown(responses)
#st.markdown(code_responses)
